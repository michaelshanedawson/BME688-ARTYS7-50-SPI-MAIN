...
## LEDs
#set_property -dict { PACKAGE_PIN E18   IOSTANDARD LVCMOS33 } [get_ports { led_tri_io[0] }]; #IO_L16N_T2_A27_15 Sch=led[2]
...
#set_property -dict { PACKAGE_PIN L13   IOSTANDARD LVCMOS33 } [get_ports { ck_io0_tri_io }]; #IO_0_14 Sch=ck_io[0]
